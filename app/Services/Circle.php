...
class Circle extends Shape
{
    ...
    public function getTransformationForCircleType(string $type): array
    {
        if ($type === 'Circle') {
            return $this->getTransformationData();
        }
    ...
    public function getTransformationForCircleShape(Shape $shape): array
    {
        if ($shape instanceof Circle) {
            return $this->getTransformationData();
        }
    ...
    public function getTransformationForCircleTypeShape(string $type): array
    {
        if ($type === 'Circle') {
            return $this->getTransformationData();
        }
    ...
    public function getTransformationMatrixForCircleType(string $type): array
    {
        if ($type === 'Circle') {
            return $this->getTransformationMatrix();
        }
    ...
    public function getTransformationMatrixForCircleTypeShape(Shape $shape): array
    {
        if ($shape instanceof Circle) {
            return $this->getTransformationMatrix();
        }
