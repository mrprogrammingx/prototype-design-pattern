...
class Rectangle extends Shape
{
    ...
    public function getBoundingCircleCircumferenceLength(): float
    {
        return $this->getBoundingCirclePerimeter();
    }

    public function getBoundingCircleCircumferenceArea(): float
    {
    ...
    public function getBoundingCircleCircumference(): float
    {
        return $this->getBoundingCirclePerimeter();
    }
